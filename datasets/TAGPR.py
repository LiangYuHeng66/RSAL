...
class TAGPR(BaseDataset):

    dataset_dir = 'TAG-PEDES'

    def __init__(self, root='', verbose=True):
        super(TAGPR, self).__init__()
        self.dataset_dir = op.join(root, self.dataset_dir)
        self.img_dir = op.join(self.dataset_dir)
        
        self.anno_path = op.join(self.dataset_dir, 'raw_reid.json')
