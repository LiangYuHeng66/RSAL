...
if __name__ == '__main__':
    ...
    args.output_dir = op.join(args.output_dir, args.dataset_name, f'{cur_time}_{args.loss_names}_{args.batch_size}_{args.lr}')


    logger = setup_logger('TAGPR', save_dir=args.output_dir, if_train=args.training, distributed_rank=get_rank())

    logger.info("Random Seed: {}".format(1+get_rank()))
