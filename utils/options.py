...
def get_args():
    parser = argparse.ArgumentParser(description="TAGPR Args")
    ######################## general settings ########################
    ...
    parser.add_argument("--softlabel_ratio", default=0.5, type=float)
    parser.add_argument("--nitc_loss_weight", default=1.0, type=float)
    parser.add_argument("--ritc_loss_weight", default=1.0, type=float)
